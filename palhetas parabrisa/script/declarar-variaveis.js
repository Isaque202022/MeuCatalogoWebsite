...
//const f_input_referencia = document.getElementById('campo-referencia')
...
const f_select_posicao = document.getElementById('select-posicao')
const f_select_tamanho_de = document.getElementById('select-tamanho-de')
const f_select_tamanho_ate = document.getElementById('select-tamanho-ate')
//const f_select_montadora = document.getElementById('')
//const f_select_veiculo =document.getElementById('')
